...
const HomeIcon = ( { color} ) => {
    return (
        ...
        <defs>
        <filter id="filter0_b_77_315" x="-4.56" y="-4.56" width="35.8568" height="37.1587" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
